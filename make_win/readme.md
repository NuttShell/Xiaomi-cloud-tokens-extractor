...
Если `pyconfig.json` отсутствует, или указанной в нем версии нет на python.org, скрипт в интерактивном режиме
предложит выбрать версию python и архитектуру.
Python будет скачан и установлен в папку \python рядом со скриптом. 

Установленный Python не прописывается в системе и никак не влияет на уже установленные копии python других версий.
